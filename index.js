...
var AddToHomeScreen = function(settings = {}) {
  ...
  var htmlContent =
    ...
    `Install <strong>${brandName} web app</strong> on your iOS device: tap share and <strong> Add to Home Screen</strong> ↓<br><a href="/add-to-home-screen">Watch video</a> tutorial here`;
